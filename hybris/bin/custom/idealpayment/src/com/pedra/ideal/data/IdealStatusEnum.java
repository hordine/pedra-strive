...
public enum IdealStatusEnum
{
	...
	private IdealStatusEnum(final String statusCode, final boolean isFinalStatus)
	{
	...
	public static IdealStatusEnum getStatusForCode(final String statusCode)
	{
		IdealStatusEnum result = null;
		for (final IdealStatusEnum value : IdealStatusEnum.values())
		{
