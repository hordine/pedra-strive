...
/**
 * This is the extension manager of the Idealpayment extension.
 */
public class IdealpaymentManager extends GeneratedIdealpaymentManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(IdealpaymentManager.class.getName());
	 ...
	 */
	public static IdealpaymentManager getInstance()
	{
		return (IdealpaymentManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				IdealpaymentConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public IdealpaymentManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of IdealpaymentManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of IdealpaymentManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of IdealpaymentManager called, current tenant: " + getTenant().getTenantID());
		}
	}
