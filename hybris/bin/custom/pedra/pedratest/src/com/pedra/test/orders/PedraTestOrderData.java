 ...
 */
public class PedraTestOrderData
{
	private static final Logger LOG = Logger.getLogger(PedraTestOrderData.class);
	...
	{
		// Lookup the site
		final CMSSiteModel cmsSite = getCmsAdminSiteService().getSiteForId("pedra");
		// Lookup the customer
	...
	{
		// Create sample order in the pedra site
		{
			final Map<String, Long> products = new HashMap<String, Long>();
			products.put("0051", Long.valueOf(1)); // Limestone
			products.put("0052", Long.valueOf(1)); // James Taylor CD
			createSampleOrder("pedra", "OrderHistoryUser@test.com", "USD", products, createUkAddressData());
		}
