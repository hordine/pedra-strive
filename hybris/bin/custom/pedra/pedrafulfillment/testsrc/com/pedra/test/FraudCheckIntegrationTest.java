...
import com.pedra.events.OrderFraudCustomerNotificationEvent;
import com.pedra.test.events.TestEventListenerCountingEvents;
...
public class FraudCheckIntegrationTest extends ServicelayerTest
{
	...
	/**
	 * Load bean definition from pedrafulfillment-spring-test-fraudcheck.xml
	 */
	@BeforeClass
	public static void beforeClass()
	{
		...
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/pedrafulfillment/test/pedrafulfillment-spring-test-fraudcheck.xml"));
	...
	protected static final String PARAM_NAME_MIN_PERIOD_WAITING_FOR_CLEANUP_IN_SECONDS = "pedrafulfillment.fraud.minPeriodWaitingForCleanUpInSeconds";
	protected static final String PARAM_NAME_FRAUD_SCORE_LIMIT = "pedrafulfillment.fraud.scoreLimit";
	protected static final String PARAM_NAME_FRAUD_SCORE_TOLERANCE = "pedrafulfillment.fraud.scoreTolerance";
	...
	public void before() throws Exception
	{
		...
		{
			importCsv("/pedrafulfillment/test/testTicketEssentialData.csv", "utf-8");
		}
		importCsv("/pedrafulfillment/test/testWarehouses.csv", "utf-8");
	...
	{
		final String processDefinitionName = PedrafulfillmentConstants.ORDER_PROCESS_NAME;
	...
	protected String submitOrderMock(final OrderModel order)
	{
		final OrderProcessModel businessProcessModel = (OrderProcessModel) businessProcessService.createProcess(
				PedrafulfillmentConstants.ORDER_PROCESS_NAME + order.getCode() + +System.currentTimeMillis(),
				PedrafulfillmentConstants.ORDER_PROCESS_NAME);
