...
import com.pedra.test.actions.TestActionTemp;
...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception //NOPMD
	{
		...
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/pedrafulfillment/test/pedrafulfillment-spring-test.xml"));
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/pedrafulfillment/test/pedrafulfillment-spring-test-fraudcheck.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/pedrafulfillment/test/process/order-process-spring.xml"));
		...
		definitonFactory.add("classpath:/pedrafulfillment/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/pedrafulfillment/test/testBasics.csv", "windows-1252");
			importCsv("/pedrafulfillment/test/testCatalog.csv", "windows-1252");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/pedrafulfillment/test/pedrafulfillment-spring-testcleanup.xml"));
