 ...
 *  
 */
package com.pedra.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(PedrafulfillmentConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(PedrafulfillmentConstants.PARENT_PROCESS);
