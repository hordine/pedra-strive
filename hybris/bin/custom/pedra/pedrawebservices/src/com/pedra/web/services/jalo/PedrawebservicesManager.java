 ...
 *  
 */
package com.pedra.web.services.jalo;
...
import com.pedra.web.services.constants.PedrawebservicesConstants;



/**
 * This is the extension manager of the Pedrawebservices extension.
 */
public class PedrawebservicesManager extends GeneratedPedrawebservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(PedrawebservicesManager.class.getName());
	 ...
	 */
	public static PedrawebservicesManager getInstance()
	{
		return (PedrawebservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				PedrawebservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PedrawebservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of PedrawebservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of PedrawebservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of PedrawebservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
