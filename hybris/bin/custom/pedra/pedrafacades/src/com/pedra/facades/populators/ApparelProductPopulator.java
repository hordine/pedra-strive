...
import com.pedra.facades.product.data.ApparelProductData;
import com.pedra.facades.product.data.GenderData;
...
public class ApparelProductPopulator implements Populator<ProductModel, ProductData>
{
	...
	public void populate(final ProductModel source, final ProductData target) throws ConversionException
	{
		...
		if (target instanceof ApparelProductData && baseProduct instanceof PedraProductModel)
		{
			final PedraProductModel apparelProductModel = (PedraProductModel) baseProduct;
