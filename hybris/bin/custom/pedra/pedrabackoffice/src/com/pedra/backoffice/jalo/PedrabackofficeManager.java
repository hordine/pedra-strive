 ...
 *  
 */
package com.pedra.backoffice.jalo;
...
import com.pedra.backoffice.constants.PedrabackofficeConstants;
 ...
 */
public class PedrabackofficeManager extends GeneratedPedrabackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(PedrabackofficeManager.class.getName());
	 ...
	 */
	public static PedrabackofficeManager getInstance()
	{
		return (PedrabackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(PedrabackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PedrabackofficeManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of PedrabackofficeManager called.");
		}
	}
