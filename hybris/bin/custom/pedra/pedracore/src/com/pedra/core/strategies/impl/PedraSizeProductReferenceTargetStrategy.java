 ...
 *  
 */
package com.pedra.core.strategies.impl;
 ...
 */
public class PedraSizeProductReferenceTargetStrategy implements ProductReferenceTargetStrategy
{
	...
	{
		if (sourceProduct instanceof PedraSizeVariantProductModel && reference.getTarget() instanceof PedraStyleVariantProductModel)
		{
