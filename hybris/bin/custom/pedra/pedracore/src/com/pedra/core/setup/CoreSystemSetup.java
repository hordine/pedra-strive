...
public class CoreSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		final String projectdataRelativeUpdateDirectoryValue = getStringSystemSetupParameter(context, UPDATE_DIRECTORY);
		...
		if (importAccessRights && extensionNames.contains("productcockpit"))
		{
			...
			importImpexFile(context, "/pedracore/import/cockpits/productcockpit/productcockpit-access-rights.impex");
		...
		{
			final File projectdataUpdateDirectory = getProjectdataUpdateDirectory("/" + projectdataRelativeUpdateDirectoryValue);
			if (projectdataUpdateDirectory != null && projectdataUpdateDirectory.listFiles() != null)
			{
				final String relativePath = Config.getString("projectdata.update.folder", "/pedracore/import/versions") + "/"
	...
	private File getProjectdataUpdateDirectory(String relativeUpdateDirectory)
	{
		...
		String projectdataUpdateFolderProperty = Config.getString("projectdata.update.folder", "/pedracore/import/versions");
	...
	private class ImportCatalogAwareDataStrategy
	{
		...
		private void createContentCatalog(final String contentCatalogName)
		{
			...
			importImpexFile(context, "/pedracore/import/contentCatalogs/" + contentCatalogName + "ContentCatalog/catalog.impex",
					true);
			importImpexFile(context, "/pedracore/import/contentCatalogs/" + contentCatalogName + "ContentCatalog/cms-content.impex",
					false);
		...
		private void createProductCatalog(final String productCatalogName)
		{
			...
			importImpexFile(context, "/pedracore/import/productCatalogs/" + productCatalogName + "ProductCatalog/catalog.impex",
					true);
