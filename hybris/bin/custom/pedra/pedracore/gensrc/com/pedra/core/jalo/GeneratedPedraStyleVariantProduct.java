...
/**
 * Generated class for type {@link com.pedra.core.jalo.PedraStyleVariantProduct PedraStyleVariantProduct}.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedPedraStyleVariantProduct extends VariantProduct
{
	/** Qualifier of the <code>PedraStyleVariantProduct.swatchColors</code> attribute **/
	public static final String SWATCHCOLORS = "swatchColors";
	/** Qualifier of the <code>PedraStyleVariantProduct.style</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>PedraStyleVariantProduct.style</code> attribute.
	...
	public String getStyle(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedPedraStyleVariantProduct.getStyle requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>PedraStyleVariantProduct.style</code> attribute. 
	...
	public void setStyle(final SessionContext ctx, final String value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedPedraStyleVariantProduct.setStyle requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>PedraStyleVariantProduct.swatchColors</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>PedraStyleVariantProduct.swatchColors</code> attribute. 
