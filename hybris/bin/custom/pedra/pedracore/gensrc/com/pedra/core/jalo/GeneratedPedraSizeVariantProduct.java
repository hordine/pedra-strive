...
/**
 * Generated class for type {@link com.pedra.core.jalo.PedraSizeVariantProduct PedraSizeVariantProduct}.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedPedraSizeVariantProduct extends PedraStyleVariantProduct
{
	/** Qualifier of the <code>PedraSizeVariantProduct.size</code> attribute **/
	public static final String SIZE = "size";
	protected static final Map<String, AttributeMode> DEFAULT_INITIAL_ATTRIBUTES;
	static
	{
		final Map<String, AttributeMode> tmp = new HashMap<String, AttributeMode>(PedraStyleVariantProduct.DEFAULT_INITIAL_ATTRIBUTES);
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>PedraSizeVariantProduct.size</code> attribute.
	...
	public String getSize(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedPedraSizeVariantProduct.getSize requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>PedraSizeVariantProduct.size</code> attribute. 
	...
	public void setSize(final SessionContext ctx, final String value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedPedraSizeVariantProduct.setSize requires a session language", 0 );
		}
