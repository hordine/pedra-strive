...
import com.pedra.constants.PedracommerceservicesConstants;



/**
 * This is the extension manager of the Pedracommerceservices extension.
 */
public class PedracommerceservicesManager extends GeneratedPedracommerceservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(PedracommerceservicesManager.class.getName());
	 ...
	 */
	public static PedracommerceservicesManager getInstance()
	{
		return (PedracommerceservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				PedracommerceservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PedracommerceservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of PedracommerceservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of PedracommerceservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of PedracommerceservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
