 ...
 * 
 */
package com.pedra.commerce.hmc;
 ...
 * 
 */
public class PedracommerceservicesHMCExtension extends HMCExtension
{

	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(PedracommerceservicesHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.pedra.commerce.hmc.locales";


	/**
	 * 
	 */
	public PedracommerceservicesHMCExtension()
	{
