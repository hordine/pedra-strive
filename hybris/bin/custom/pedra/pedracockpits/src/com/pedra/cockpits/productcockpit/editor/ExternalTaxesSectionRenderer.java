 ...
 *  
 */
package com.pedra.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("pedracockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("pedracockpits.product.externalTaxes"));
