 ...
 *  
 */
package com.pedra.cockpits.setup;
 ...
 */
@SystemSetup(extension = PedraCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(PedraCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(PedraCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						PedraCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				importImpexFile(context, "/pedracockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
			}
