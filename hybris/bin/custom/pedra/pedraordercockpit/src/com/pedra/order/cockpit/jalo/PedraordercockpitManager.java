 ...
 *  
 */
package com.pedra.order.cockpit.jalo;
...
import com.pedra.order.cockpit.constants.PedraordercockpitConstants;


/**
 * This is the extension manager of the pedraordercockpit extension.
 */
public class PedraordercockpitManager extends GeneratedPedraordercockpitManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger(PedraordercockpitManager.class.getName());
	 ...
	 */
	public static final PedraordercockpitManager getInstance()
	{
		return (PedraordercockpitManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				PedraordercockpitConstants.EXTENSIONNAME);
	}
