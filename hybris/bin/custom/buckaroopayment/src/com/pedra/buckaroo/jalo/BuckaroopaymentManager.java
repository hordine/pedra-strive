...
/**
 * This is the extension manager of the Buckaroopayment extension.
 */
public class BuckaroopaymentManager extends GeneratedBuckaroopaymentManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(BuckaroopaymentManager.class.getName());
	 ...
	 */
	public static BuckaroopaymentManager getInstance()
	{
		return (BuckaroopaymentManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				BuckaroopaymentConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public BuckaroopaymentManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of BuckaroopaymentManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of BuckaroopaymentManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of BuckaroopaymentManager called, current tenant: " + getTenant().getTenantID());
		}
	}
